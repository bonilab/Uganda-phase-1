 ...
 * error_handler.hxx
 *
 * This header defines error handling that can be incorporated into an
 * application allowing for "last chance" information to be extracted following
 * an unhandled exception or abort occurring.
 *
...
//
// This function needs to be set for the sigaction function on the SIGABRT
// signal in order to operate.
void crit_err_hdlr(int sig_num, siginfo_t* info, void* ucontext) {
  ...
  std::cerr << std::endl
            << "signal " << sig_num << " (" << strsignal(sig_num)
...
//
// This method needs to be registered with std::set_terminate in order to
// operate.
